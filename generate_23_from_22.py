...
NEWS_CARD_TEMPLATE = '''    <article class="news-card" data-news-id="{idx}">
        <div class="news-image">
            <img src="../images/20260323/{image}" alt="{title}" loading="lazy">
        </div>
...
# 读取22日模板
with open("/home/swg/.openclaw/workspace/news-blog/repo/history/20260323_new_template.html", "r", encoding="utf-8") as f:
    content = f.read()
...
# 写入新文件
with open("/home/swg/.openclaw/workspace/news-blog/repo/history/20260323.html", "w", encoding="utf-8") as f:
    f.write(content)
